...
## part3: evaluating diversity among samples at a single site, single year, across sampling windows
## part4: evaluating diversity among samples at a multiple sites, single year, across sampling windows
## part5: evaluating diversity among samples at a multiple sites, multiple years, sing sampling window
...
## save plot
ggsave("~/github/nhguano/supplementaryData/figureS4_windows2016_dunn_heatmap_pvalues_all.png", width = 21, height = 12, units = 'cm')
ggsave("~/github/nhguano/supplementaryData/figureS4_windows2016_dunn_heatmap_pvalues_all.pdf", width = 20, height = 12, units = 'cm')
...
ggsave("~/github/nhguano/supplementaryData/figureS3_windows2016_boxplot_alphavals_all.png", width = 27, height = 14, units = 'cm', dpi=300)
ggsave("~/github/nhguano/supplementaryData/figureS3_windows2016_boxplot_alphavals_all.pdf", width = 27, height = 14, units = 'cm', dpi=450)
...
ggplot(win456_indispec_plotdat_allGroups_multigroupOnly,
  ...
  theme(strip.background = element_blank(),
        ...
        axis.text.y = element_text(size = 8),
        panel.spacing.y = unit(0.5, "lines"))
ggsave("~/github/nhguano/supplementaryData/figureS5_specindi_multigroupComps_win456_WIDE.png", width = 200, height = 150, units="mm", dpi=150)
ggsave("~/github/nhguano/supplementaryData/figureS5_specindi_multigroupComps_win456_WIDE.pdf", width = 200, height = 150, units="mm", dpi=300)
